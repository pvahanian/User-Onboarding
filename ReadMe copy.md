...
- explain what end-to-end testing is and its importance  // End to end testin goes through the whole project to ensure the user xperience is complete for business package and confidence
